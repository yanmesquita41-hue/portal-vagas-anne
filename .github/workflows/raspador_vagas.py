...
def buscar_adzuna():
    ...
    vagas_coletadas = []
    termos_chave = ["PCP", "Supply Chain", "Planejador de Produção", "Analista de Materiais", "S&OP", "MRP", "Logística Sênior"]
    cidades_alvo = ["Campinas", "Jundiaí", "Sorocaba", "Indaiatuba", "São José dos Campos", "Piracicaba", "Joinville", "Curitiba"]
...
if __name__ == "__main__":
    print("Executando agregador multi-API unificado...")
